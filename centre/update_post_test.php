            ...
            <div class="main-panel">
                <div class="content-wrapper">
                  <?php
                    $admin = new Admin();
                    $apt_id=$_GET['apt_id'];
                    $query = "SELECT * FROM `apti_test` WHERE `apt_id`='$apt_id'";
                   ...
                   <div class="background_div">
                    ...
                    <br>
                    <form action="controler_center/update_test_qution_post.php" method="post">
                       ...
                       " required>
                       <br>
                       <input type="text" name="apt_id" id="" placeholder="id" style="    border: 3px solid #12a24e;
                          width: 80%;
                          height: 40px;
                          border-radius: 4px;    padding-left: 15px;
                       " required  value="'.$row['apt_id'].'" hidden>
