...
<body>
    ...
    <section class='login' id='login'>
        ...
        <div class='form'>
            <form action="../controler_center/login.php" method="post" enctype="multipart/form-data">
                ...
                <input type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters" placeholder='•••••••••' class='password' required><br>
