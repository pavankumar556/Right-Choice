                                ...
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                  ...
                                  <div style="float: left;margin-right: 30px;">
                                    ...
                                    <h5 style="color: white;">'.$row['p_address'].'</h5>
                                      <h6>Description</h6>
                                      <h5 style="color: white; width:280px;">'.$row['p_description'].'</h5>
                                  </div>
                                  <div style="float: left;margin-right: 30px;">
                                    <h6>logitude</h6>
                                  ...
                                  <div style="float: left;margin-right: 30px;">
                                    ...
                                    ';
                                      $t="";
                                      $query_check = "SELECT * FROM `apti_test`";
                                      $stmt_check = $admin->ret($query_check);
                                      while($row_check = $stmt_check->fetch(PDO::FETCH_ASSOC)){
                                        if($row['p_id']==$row_check['p_id']){
                                              $t=$row_check['p_id'];
                                      ...
                                      // echo $t;
                                  if($row['p_id']==$t){
                                    echo '<a type="submit" class="input_delete"
                                    href="view_center_test.php?p_id='.$row['p_id'].'" style="text-decoration: none;"><b>View Test</b> </a><br><br>
                                    <br><a type="submit" class="input_update" style="text-decoration: none;"
                                    href="create_test_post.php?p_id='.$row['p_id'].'"><b>Add Qutions</b></a><br><br>
                                    <br>';
                                  }else{
                                    echo '<a type="submit" class="input_delete"
                                    href="create_test_post.php?p_id='.$row['p_id'].'" style="text-decoration: none;"><b>Create Test</b> </a><br><br>
                                  <br>';
                                  }
                               echo ' </div>';
                                $ac++;
