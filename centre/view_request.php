                                  ...
                                  if($row['c_id']==$_SESSION['c_id']){
                                    if($row['req_requst']==""){
                                      ...
                                      <a type="submit" class="input_delete"
                                        href="controler_center/reject_request.php?req_id='.$row['req_id'].'" style="text-decoration: none;"><b>Reject</b> </a>
                                        <a type="submit" class="input_update" style="text-decoration: none;"
                                      href="controler_center/approove_request.php?req_id='.$row['req_id'].'&&p_id='.$row_post['p_id'].',&&p_seats='.$row_post['p_seats'].',&&s_id='.$s_id.'"><b>Approove</b></a><br><br>
                                      <br><br>
                                      <br>
