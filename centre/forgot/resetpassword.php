    ...
    <section class='login' id='login'>
        ...
        <div class='form'>
            <form action="../controler_center/forgot.php" method="post" enctype="multipart/form-data" >
                ...
                <input type="text" placeholder='Confirm password' attern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters" name="confirm_password" class='text' id="otp" style="margin-top: 10px;" required>
                <!-- <br> -->
