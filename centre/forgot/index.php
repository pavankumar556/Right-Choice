...
<body>
    ...
    <section class='login' id='login'>
        ...
        <div class='form'>
            <form action="../controler_center/forgot.php" method="post" enctype="multipart/form-data" >
                <input type="email" placeholder='Email Address' class='text' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}$" title="xyz@something.com" name="uname" id="username" required>
                <!-- <p id="empty">Please Enter Your Email address</p> -->
                <!-- <br> -->
                <!-- <input type="text" placeholder='OTP' class='text' id="otp" style="margin-top: 10px;"> -->
                <!-- <br> -->
                <input type="submit" class='btn-login' id='do-login-now' value="Send Email" name="emailbtn" style="margin-top: 10px;" >
          <!-- <br>      <input type="submit" class='btn-login' id='dologin' value="Verify Now" name="verifybtn" style="margin-top: 10px;"> -->
