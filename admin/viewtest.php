                  ...
                  <div class="container-fluid">
                     ...
                     <div class="row">
                        ...
                        <div class="card">
                            <?php
                                $admin = new Admin();
                                $query = "SELECT * FROM `apti_test` ORDER BY `apt_stream`";
                                $stmt = $admin->ret($query);
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                 if($row['apt_type']==="admin"){
                                    ...
                                    <a type="submit"  class="input_delete" href="controler_admin/delete_test_qution.php?apt_id='.$row['apt_id'].'"><b>DELETE</b> </a><br><br>
                                    <input type="text"  readonly class="input_type" value="'.$row['apt_option1'].'" style="background: #ff8900;">
                                    <a type="submit"  class="input_update" href="update_test_qutions.php?apt_id='.$row['apt_id'].'"><b>UPDATE</b></a><br><br>
