...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
   ...
   <td>".$row['p_seats']. "</td>
   <td>".$row['p_longitude']."</td>
   <td>".$row['p_latitude']."</td>
   <td><a href='controler_admin/delete_post.php?p_id=".$row['p_id']."' class='btn_delete'>Delete</a></td>
   </tr>";
   $a++;
