...
if(isset($_POST['contact'])){
        ...
        <div style="background-color: #d6e7f0; width: 50%; height: fit-content; margin-top: 60px; margin-bottom: 20px; text-align: center; margin: auto;border-top-left-radius: 14px;
            ...
            <div style="background-color: #d6e7f0;">
                ...
                <h1 style="
                                                                                  ...
                                                                                  color: #052d3d;
                                                                                  line-height: 1.5;">'.$name.' is trying contact You</h1>
                <h1 style=" 
    ...
    $admin = new Admin();
    $result = $admin->mail_send($subject,'ritheshjaston22@gmail.com',$mes);

    //opens file in append mode
    $t=time();
    $text="\n".date("Y-m-d",$t)."  ".$name."  ".$email."  ".$subject."  ".$message."   "." -Contact student";
    $fp = fopen('../log.txt', 'a');  
    fwrite($fp, $text);  
