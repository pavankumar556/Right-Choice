...
<body class="inner_page tables_page">
        ...
        <div class="inner_container">
            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid" style="background-image:url('img/choosecareer_background.jpg');">
                        ...
                        <div class="row">
                            ...
                            color: blue;">Top Courses For You</h1>
                            <!-- <script>
 ...
 $admin = new Admin();
 $query = "SELECT * FROM `post` ORDER BY '$long'=`p_longitude`";
