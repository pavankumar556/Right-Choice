...
<body>
    ...
    <section class='login' id='login'>
        ...
        <div class='form'>
            <form action="../controler_student/login.php" method="post" enctype="multipart/form-data">
                ...
                <input type="password" name="password" placeholder='•••••••••' class='password' pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required>
                <input type="text" name="longitude"  class='password' id="longitude" hidden>
                <input type="text" name="latitude"  class='password' id="latitude" hidden><br>
    ...
    <script>
        var valid=document.getElementById("invalid");
